...
This project is a **To-Do List application** developed using **HTML, CSS, and JavaScript**, with the main goal of reinforcing core **JavaScript fundamentals** and practical **DOM manipulation**.

You can see the live project <a href="https://Eric-Alves1.github.io/to-do-list">here</a>
